...
export function createSlider(sliderData) {
  const newSlider = {
    id: nextId++,
    ...sliderData,
    ordering: sliderData.ordering || Math.max(...sliders.map((s) => s.ordering || 0)) + 1,
...
export function updateSlider(id, updateData) {
